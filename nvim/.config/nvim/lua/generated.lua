...
local ____exports = {}
____exports.pipe = function(...)
    local ____bindingPattern0 = {...}
    local rest
    local first
    first = ____bindingPattern0[1]
...
____exports.partial = function(fn, ...)
    local params = {...}
    return function(...)
        local rest = {...}
        return fn(__TS__Spread(params:concat(rest)))
    end
end
____exports.lazy = function(fn, ...)
    local params = {...}
    return function() return fn(__TS__Spread(params)) end
end
____exports.toUnary = function(fn) return function(params) return fn(__TS__Spread(params)) end end
return ____exports
 end,
["lib.obj"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
...
local function mapValues(obj, fn)
    local mapped = {}
    Object:entries(obj):forEach(function(____bindingPattern0)
        local value
        local key
        key = ____bindingPattern0[1]
        value = ____bindingPattern0[2]
        local ____fn_result_0 = fn(value)
        mapped[key] = ____fn_result_0
        return ____fn_result_0
    end)
    return mapped
end
local function mapKeys(obj, fn)
    local mapped = {}
    Object:entries(obj):forEach(function(____bindingPattern0)
        local value
        local key
        key = ____bindingPattern0[1]
        value = ____bindingPattern0[2]
        local ____value_1 = value
        mapped[fn(key)] = ____value_1
        return ____value_1
    end)
    return mapped
end
____exports.keys = keys
____exports.entries = entries
____exports.mapValues = mapValues
____exports.mapKeys = mapKeys
return ____exports
 end,
["lib.string"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
____exports.chars = function(str) return str:split("") end
return ____exports
 end,
["utils.togglers"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
...
____exports.toggle_bg = toggle_bg
____exports.toggle_diagnostics = toggle_diagnostics
return ____exports
 end,
["plugins.plugin"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
____exports.plugin = function(def, setup) return {def = def, setup = setup} end
return ____exports
 end,
["plugins.telescope"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
local ____telescope = require("telescope")
local setup = ____telescope.setup
local ____obj = require("lib.obj")
local mapValues = ____obj.mapValues
local ____plugin = require("plugins.plugin")
local plugin = ____plugin.plugin
____exports.telescope = plugin(
    "nvim-telescope/telescope.nvim",
    function() return setup({}) end
)
____exports.leaderMappings = mapValues(
    {
        ["/"] = "live_grep",
        b = "buffers",
        ["*"] = "lsp_references",
    ...
    function(cmd) return function() return vim.cmd("Telescope " .. tostring(cmd)) end end
)
return ____exports
 end,
["keymap"] = function(...) 
...
local ____exports = {}
local ____fn = require("lib.fn")
local lazy = ____fn.lazy
local partial = ____fn.partial
local ____obj = require("lib.obj")
local mapKeys = ____obj.mapKeys
local ____string = require("lib.string")
local chars = ____string.chars
local ____togglers = require("utils.togglers")
local toggle_bg = ____togglers.toggle_bg
local toggle_diagnostics = ____togglers.toggle_diagnostics
local telescope = require("plugins.telescope")
local set = vim.keymap.set
local nmap = partial(set, "n")
local vmap = partial(set, "v")
local function cmd(vimCmd)
    return lazy(vim.cmd, vimCmd)
end
local leaderMappings = __TS__ObjectAssign(
    {
        ["<leader>"] = ":",
        m = cmd("make"),
        w = cmd("write"),
...
local nmaps = __TS__ObjectAssign(
    {
        yon = function() return ({"set invnumber", "set invrelativenumber"}):forEach(function(s) return vim.cmd(s) end) end,
    ...
    mapKeys(
        leaderMappings,
        function(key) return "<leader>" .. tostring(key) end
    )
)
local function setKeys()
    vim.g.mapleader = " "
    Object:entries(nmaps):forEach(function(____bindingPattern0)
        local right
        local left
        left = ____bindingPattern0[1]
        right = ____bindingPattern0[2]
        return nmap(left, right)
    end)
    set(
        chars("ivt"),
        "fd",
    ...
    chars("HJKL"):forEach(function(key) return nmap(
        ("<C-" .. tostring(key)) .. ">",
        ("<C-W><C-" .. tostring(key)) .. ">"
    ) end)
...
local function setOptions()
    return Object:entries(options):forEach(function(____bindingPattern0)
        local value
        local key
        key = ____bindingPattern0[1]
        value = ____bindingPattern0[2]
        local ____value_0 = value
        vim.opt[key] = ____value_0
        return ____value_0
    end)
end
____exports.setOptions = setOptions
return ____exports
 end,
["index"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
local ____keymap = require("keymap")
local setKeys = ____keymap.setKeys
local ____options = require("options")
local setOptions = ____options.setOptions
local ____plugins = require("plugins")
local loadPlugins = ____plugins.loadPlugins
...
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
local ____exports = {}
local ____nvim_2Dtreesitter_2Econfigs = require("nvim-treesitter.configs")
local setup = ____nvim_2Dtreesitter_2Econfigs.setup
local ____plugin = require("plugins.plugin")
local plugin = ____plugin.plugin
____exports.treesitter = plugin(
    "nvim-treesitter/nvim-treesitter",
    function() return setup({ensure_installed = {
        "c",
        "lua",
        "go",
        "rust",
        ...
        "bash",
        "yaml"
    }, sync_install = false, highlight = {enable = true, additional_vim_regex_highlighting = false}}) end
)
return ____exports
 end,
...
["utils.run-typescript-file"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
 end,
["utils.switch-to-alt-file"] = function(...) 
--[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
 end,
}
